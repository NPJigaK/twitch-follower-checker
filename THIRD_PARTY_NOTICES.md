...
- `next` 15.5.25 and `eslint-config-next` 15.5.25 — <https://github.com/vercel/next.js/blob/canary/license.md>
- `next-sitemap` 4.2.3 — <https://github.com/iamvishnusankar/next-sitemap/blob/master/LICENSE>
- `nextra` 3.3.1 and `nextra-theme-docs` 3.3.1 — <https://github.com/shuding/nextra/blob/main/LICENSE>
