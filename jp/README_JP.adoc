...
https://github.com/NPJigaK/twitch-follower-checker/issues/new[Issue として起票]して頂ければと思います。
...
このプロジェクトは https://github.com/NPJigaK/twitch-follower-checker/blob/main/LICENSE[Apache License 2.0] に準拠してライセンスされています。
